...
<body>
<h1>Open hyperCell</h1>
<p>Enter hyperCell Password.</p><input type="password" id="passwordBox" name="passwordBox"
placeholder="Type Password Here"> <button onclick="loadFiles()">Open</button>
<ol id="fileList"></ol>
<hr>
<a href="https://github.com/jaketrock/hypercell">Made with hyperCell</a>
